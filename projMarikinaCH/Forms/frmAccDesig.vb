...
Public Class frmAccDesig
    ...
    Private Sub frmAccDesig_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        lstList.Clear()
        header()
    ...
    Sub SaveDesig()
        ...
        Catch ex As Exception
            ...
            Save_ErrLogs("SaveDesig", ex.Message)
        End Try
    End Sub
    ...
    Sub delDesig(ByVal desig As String)
        ...
        Catch ex As Exception
            Save_ErrLogs("delDesig", ex.Message)
