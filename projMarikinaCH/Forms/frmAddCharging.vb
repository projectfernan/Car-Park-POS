...
Public Class frmAddCharging
    ...
    Sub saveL()
        ...
        Catch ex As Exception
            Save_ErrLogs("[saveL] Add charging rule", ex.Message)
    ...
    Sub editL()
        Try
            ...
            Me.Close()
        Catch ex As Exception
            Save_ErrLogs("[editL] Update Charging Rules", ex.Message)
    ...
    Function chkKey(ByVal key As String)
        Try
            ...
            End If
        Catch ex As Exception
            Save_ErrLogs("[chkKey] Charging Rules", ex.Message)
    ...
    Function chkVehType(ByVal Veh As String)
        Try
            ...
            End If
        Catch ex As Exception
            Save_ErrLogs("[chkVehType] Charging Rules", ex.Message)
            MessageBox.Show(ex.Message, "Error Message", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Return False
        End Try
    End Function
