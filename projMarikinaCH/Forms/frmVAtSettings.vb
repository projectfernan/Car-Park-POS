...
Public Class frmVAtSettings
    ...
    Sub saveVat()
        ...
        Catch ex As Exception
            Save_ErrLogs("[saveVat] frmvatSettings", ex.Message)
    ...
    Sub viewVatSettings()
        ...
        Try
            ...
            txtSetVat.Text = CDbl(rs("Vat").Value)
        Catch ex As Exception
            Save_ErrLogs("[saveVat] frmvatSettings", ex.Message)
            MessageBox.Show(ex.Message, "Vat Settings Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    End Sub
