...
Public Class frmBreakdown
    ...
    Sub fillL()
        ...
        Dim lup As Short
        rs = New Recordset
        rs = conSqlLoc.Execute("select * from tblbreakdown where Operator = '" & MainForm.TxtOp.Text & "' and BussDate like '" & MainForm.txtBussDate.Text & "%' order by Denomination Desc")
    ...
    Function TotalCash(ByVal bussdt As Date) As Double
        ...
        Try
            ...
            Dim rs As New Recordset
            rs = New Recordset
            rs = conSqlLoc.Execute("select sum(TotalAmt) as TotalCash from tblbreakdown where Operator = '" & MainForm.TxtOp.Text & "' and BussDate like '" & Petsa & "%'")
    ...
    Sub saveCashOut()
        ...
        Try
            Dim rs As New Recordset
            rs = New Recordset
            rs = conSqlLoc.Execute("insert into tblcashout(CashOut,CashOutBy,BussDate)VALUES(" & _
               CDbl(txtTotalCash.Text) & ",'" & _
               cboCashier.Text & "','" & _
               MainForm.txtBussDate.Text & "')")
        Catch ex As Exception
            Save_ErrLogs("[saveCashOut] frmBreakdown", ex.Message)
        End Try
    ...
    Sub ClearBreakdown()
        ...
        Catch ex As Exception
            Save_ErrLogs("[ClearBreakdown] frmBreakdown", ex.Message)
        End Try
    End Sub
    ...
    Sub AddDeno(ByVal Qty As Integer, ByVal Deno As Double)
        ...
        Try
            ...
            rs.Update()
        Catch ex As Exception
            Save_ErrLogs("[AddDeno] frmBreakdown", ex.Message)
        End Try
    End Sub
    ...
    Private Sub cmdCashOut_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdCashOut.Click
        ...
        If conLocal() = True Then
            CashOut_rep(cboCashier.Text, My.Settings.BussDate, nem)
        End If
    ...
    Public Sub CashierList(ByVal cbo As ComboBox)
        Try
            ...
            End While
        Catch ex As Exception
            Save_ErrLogs("[CashierList] frmBreakdown", ex.Message)
        End Try
    End Sub
    ...
    Function TotalCash(ByVal bussdt As Date, ByVal op As String) As Double
        ...
        Try
            ...
            End If
        Catch ex As Exception
            Save_ErrLogs("[TotalCash] frmBreakdown", ex.Message)
            Return 0
        End Try
    End Function
