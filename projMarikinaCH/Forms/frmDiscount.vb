...
Public Class frmDiscount
    ...
    Function VerDnameL() As Boolean
        ...
        Catch ex As Exception
            Save_ErrLogs("[VerDnameL]", ex.Message)
            Return False
        End Try
    End Function
    ...
    Sub fillL()
        Try
            ...
            End If
        Catch ex As Exception
            Save_ErrLogs("[fillL] frmDiscount", ex.Message)
        End Try
    End Sub
    ...
    Sub saveL()
        Try
            ...
            disabl()
        Catch ex As Exception
            Save_ErrLogs("[saveL] frmDiscount", ex.Message)
    ...
    Sub EditL()
        Try
            ...
            disabl()
        Catch ex As Exception
            Save_ErrLogs("[EditL] frmDiscount", ex.Message)
    ...
    Sub delL()
        ...
        Catch ex As Exception
            Save_ErrLogs("[delL] frmDiscount", ex.Message)
    ...
    Sub slctRecL()
        Try
            ...
            End If
        Catch ex As Exception
            Save_ErrLogs("[slctRecL] frmDiscount", ex.Message)
