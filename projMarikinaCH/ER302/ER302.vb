...
Module ER302
    ...
    'int WINAPI rf_beep
    Public Declare Function rf_beep Lib "MasterRD.dll" (ByVal icdev As Short, ByVal msec As Short) As Integer

    'int WINAPI rf_light
    Public Declare Function rf_light Lib "MasterRD.dll" (ByVal icdev As Short, ByVal color As Short) As Integer
End Module
