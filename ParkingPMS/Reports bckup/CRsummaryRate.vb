...
Public Class CRsummaryRate
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ParkingPMS.CRsummaryRate.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRsummaryRate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRsummaryRate = New CRsummaryRate()
        rpt.Site = Me.Site
        Return rpt
    End Function
