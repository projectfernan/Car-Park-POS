...
Public Class frmUpdateSettigns
    ...
    Sub delAccDesig()
        Try
            ...
            rs = conSqlClient.Execute("delete from tblaccdesig")
    ...
    Sub delMonthly()
        Try
            ...
            rs = conSqlClient.Execute("delete from tblmonthyrate")
        Catch ex As Exception
    ...
    Sub upLoadAccDesig()
        Try
            ...
            rs1 = New Recordset
            rs1 = conSqlLoc.Execute("select * from tblAccdesig")
            Progbar.Value = 0
            Progbar.Maximum = rs1.RecordCount
            lup = 0
            Do While rs1.EOF = False
                rs2 = New Recordset
                rs2.Open("select * from tblAccdesig", conSqlClient, 1, 2)
                rs2.AddNew()
                rs2("Desig").Value = rs1("Desig").Value
                rs2("Logo").Value = rs1("Logo").Value
                rs2("Settings").Value = rs1("Settings").Value
                rs2("Accounts").Value = rs1("Accounts").Value
                rs2("Vehicle").Value = rs1("Vehicle").Value
                rs2("Charging").Value = rs1("Charging").Value
                rs2("FlatRate").Value = rs1("FlatRate").Value
                rs2("CutOff").Value = rs1("CutOff").Value
                rs2("CashOut").Value = rs1("CashOut").Value
                rs2("Reports").Value = rs1("Reports").Value
                rs2("Terminate").Value = rs1("Terminate").Value
                rs2.Update()
                lup = lup + 1
                Progbar.Value = lup
                rs1.MoveNext()
            Loop
            lstLoad.Items.Add("* Accounts designation successfully uploaded *")
            lstLoad.Items.Add(" ")
        Catch ex As Exception
    ...
    Sub upLoadAcc()
        Try
            ...
            Do While rs1.EOF = False
                ...
                rs1.MoveNext()
            Loop
            lstLoad.Items.Add("* System accounts successfully uploaded *")
            lstLoad.Items.Add(" ")
        Catch ex As Exception
            lstLoad.Items.Add(ex.Message)
        End Try
    ...
    Sub upLoadCharging()
        Try
            ...
            Do While rs1.EOF = False
                ...
                rs2("ChargeType").Value = rs1("ChargeType").Value
                rs2("KeyCode").Value = rs1("KeyCode").Value
                rs2.Update()
                lup = lup + 1
                Progbar.Value = lup
                rs1.MoveNext()
    ...
    Sub upLoadMOnthly()
        Try
            ...
            rs1 = New Recordset
            rs1 = conSqlLoc.Execute("select * from tblmonthlyrate")
            Progbar.Value = 0
            Progbar.Maximum = rs1.RecordCount
            lup = 0
            If rs1.EOF = False Then
                rs2 = New Recordset
                rs2.Open("select * from tblmonthlyrate", conSqlClient, 1, 2)
                rs2("MonthlyRate").Value = rs1("MonthlyRate").Value
                rs2.Update()
                lup = lup + 1
                Progbar.Value = lup
            End If

            lstLoad.Items.Add("* Monthly rate successfully uploaded *")
            lstLoad.Items.Add(" ")
        Catch ex As Exception
            lstLoad.Items.Add(ex.Message)
        End Try
        ...
        If PingMe(C_ip) = True Then
            If conClient(C_ip, C_uid, C_pwd, C_port, C_db) = True Then
                If conLocal() = True Then
                    If chkAccDesig.Checked = True Then
                        delAccDesig()
                        upLoadAccDesig()
                    End If
