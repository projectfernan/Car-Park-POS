...
Public Class frmPMSmain
    ...
    Public CapID As String
    Public CapIPad As String
    ...
    Sub RPTHeader()
        lstRPT.Columns.Add("RPT Station", 150, HorizontalAlignment.Left)
        lstRPT.Columns.Add("Location", 200, HorizontalAlignment.Left)
        lstRPT.Columns.Add("Ip Address", 300, HorizontalAlignment.Left)
        lstRPT.Columns.Add("Port", 150, HorizontalAlignment.Left)
        lstRPT.Columns.Add("Username", 150, HorizontalAlignment.Left)
    End Sub
    ...
    Sub fill()
        ...
        Dim lup As Short
        rs = New Recordset
        rs = conSqlLoc.Execute("select * from tblPOS where Station like 'Station%' and Station <> 'RPT%'")
        If rs.EOF = False Then
            For lup = 1 To rs.RecordCount
                lstList.Refresh()
                Dim viewlst As New ListViewItem
                viewlst = lstList.Items.Add(rs("Station").Value, ImageList1.Images.Count - 1)
    ...
    Sub fillRPT()
        ...
        Dim lup As Short
        rs = New Recordset
        rs = conSqlLoc.Execute("select * from tblPOS where Station like 'RPT%' and Station <> 'Station%'")
        If rs.EOF = False Then
            For lup = 1 To rs.RecordCount
                lstRPT.Refresh()
                Dim viewlst As New ListViewItem
                viewlst = lstRPT.Items.Add(rs("Station").Value, ImageList1.Images.Count - 1)
                viewlst.SubItems.Add(rs("Location").Value)
                viewlst.SubItems.Add(rs("IpAdd").Value)
                viewlst.SubItems.Add(rs("Port").Value)
                viewlst.SubItems.Add(rs("Username").Value)
    ...
    Sub CapHeader()
        Dim w As Integer = lstList2.Width / 3
        ListView1.Columns.Add("Node", w, HorizontalAlignment.Left)
        ListView1.Columns.Add("Zone IP", w, HorizontalAlignment.Left)
        ListView1.Columns.Add("Status", w, HorizontalAlignment.Left)
    End Sub
    ...
    Sub Entfill(Stat As String)
        ...
        If rs.EOF = False Then
            For lup = 1 To rs.RecordCount
                lstList2.Refresh()
                Dim viewlst As New ListViewItem
                viewlst = lstList2.Items.Add(rs("Zone").Value, Image3.Images.Count - 1)
    ...
    Function totalTR() As Integer
        ...
        Try
            ...
            Dim rs As New Recordset
            rs = conSqlLoc.Execute("select * from incomereport where TimeOut like '" & dt & "%'")
            If rs.EOF = False Then
    ...
    Function totalNet() As Double
        ...
        Try
            Dim dt As String = Format(Now, "yyyy-MM-dd")
            Dim rs As New Recordset
            rs = conSqlLoc.Execute("select sum(Total) as tt from incomereport where TimeOut like '" & dt & "%'")
            If rs.EOF = False Then
                Return rs("tt").Value
            Else
                Return 0
    ...
    Private Sub cmdAddD_Click(sender As System.Object, e As System.EventArgs)

    End Sub

    Private Sub cmdeditD_Click(sender As System.Object, e As System.EventArgs)
    ...
    Private Sub cmdVehicle_Click(sender As System.Object, e As System.EventArgs)
    ...
    Private Sub cmdAddPOS_Click(sender As System.Object, e As System.EventArgs)

    End Sub

    Private Sub cmdEditPOS_Click(sender As System.Object, e As System.EventArgs)

    End Sub

    Private Sub cmdDelPOS_Click(sender As System.Object, e As System.EventArgs)

    End Sub

    Private Sub cmdUpdateSettingsPOS_Click(sender As System.Object, e As System.EventArgs)
    ...
    Sub CapfillwStat2()
        ...
        Dim rs1 As New Recordset
        rs1 = New Recordset
        rs1 = conSqlLoc.Execute("select * from tblcapturermsg")
        If rs1.EOF = False Then
            Dim Zone As String = rs1("ExitZone").Value
            Dim Stat As String = rs1("Msg").Value

            updateFillCap(Zone, Stat)
    ...
    Sub updateFillCap(Zone As String, Stat As String)
        If conLocal() = False Then Exit Sub
    ...
    Sub delCapMsg(Zone As String)
        ...
        Try
            ...
            rs = conSqlLoc.Execute("delete from tblcapturermsg where ExitZone = '" & Zone & "'")
        Catch ex As Exception
    ...
    Private Sub cmdCommandD_Click(sender As System.Object, e As System.EventArgs)
        
    End Sub

    Private Sub cmdDelD_Click(sender As System.Object, e As System.EventArgs)
    ...
    Sub CapReplyCommand()
        ...
        Dim rs1 As New Recordset
        rs1 = New Recordset
        rs1 = conSqlLoc.Execute("select * from tblcapturercmd")
        If rs1.EOF = False Then
            Dim Zone As String = rs1("ExitZone").Value
            Dim Stat As String = rs1("Msg").Value

            frmCcomand.txtStat.Text = Stat
    ...
    Sub delCapCMD(Zone As String)
        ...
        Try
            ...
            rs = conSqlLoc.Execute("Delete from tblcapturercmd where ExitZone = '" & Zone & "'")
        Catch ex As Exception

        End Try
    End Sub

    Private Sub lstList2_Click(sender As Object, e As System.EventArgs)
        Dim viewlst As New ListViewItem
    ...
    Private Sub lstList2_SelectedIndexChanged(sender As System.Object, e As System.EventArgs)
    ...
    Private Sub cmdAddD_Click_1(sender As System.Object, e As System.EventArgs) Handles cmdAddD.Click
    ...
    Private Sub cmdeditD_Click_1(sender As System.Object, e As System.EventArgs) Handles cmdeditD.Click
    ...
    Private Sub cmdDelD_Click_1(sender As System.Object, e As System.EventArgs) Handles cmdDelD.Click
        If EntID = vbNullString Then Exit Sub
    ...
    Private Sub cmdCommandD_Click_1(sender As System.Object, e As System.EventArgs) Handles cmdCommandD.Click
        If EntID = vbNullString Then Exit Sub
        With frmDcommand
    ...
    Private Sub cmdAddPOS_Click_1(sender As System.Object, e As System.EventArgs) Handles cmdAddPOS.Click
        With frmAddPOS
    ...
    Private Sub cmdEditPOS_Click_1(sender As System.Object, e As System.EventArgs) Handles cmdEditPOS.Click
    ...
    Private Sub cmdDelPOS_Click_2(sender As System.Object, e As System.EventArgs) Handles cmdDelPOS.Click
        If conLocal() = False Then
            MsgBox("Please connect to database! ", vbExclamation, "Delete")
            Exit Sub
        End If
    ...
    Private Sub cmdUpdateSettingsPOS_Click_1(sender As System.Object, e As System.EventArgs) Handles cmdUpdateSettingsPOS.Click
        Dim viewlst As New ListViewItem
        For Each viewlst In lstList.Items
            If viewlst.Selected = True Then
                id = viewlst.SubItems(0).Text
    ...
    Private Sub cmdDownload_Click_1(sender As System.Object, e As System.EventArgs) Handles cmdDownload.Click
        Dim viewlst As New ListViewItem
        For Each viewlst In lstList.Items
            If viewlst.Selected = True Then
                id = viewlst.SubItems(0).Text
    ...
    Private Sub cmdCEdit_Click(sender As System.Object, e As System.EventArgs)
      
    End Sub

    Sub delCap(ByVal st As String)
        Dim rs As New Recordset
        If MsgBox("Are you sure do you want to delete this Exit Zone?    ", vbYesNo + vbQuestion + vbDefaultButton2, "Delete") = vbYes Then
            rs = New Recordset
            rs = conSqlLoc.Execute("delete from tblcapturer where Zone = '" & st & "'")
            MsgBox("Exit Zone successfully deleted!    ", vbInformation, "Delete")
            ListView1.Clear()
            CapHeader()
            fill()
        End If
    ...
    Private Sub cmdCDel_Click(sender As System.Object, e As System.EventArgs)
        If CapID = vbNullString Then Exit Sub
        If conLocal() = False Then
            MsgBox("Please connect to database! ", vbExclamation, "Delete")
            Exit Sub
        End If
    ...
    Private Sub cmdCommandC_Click(sender As System.Object, e As System.EventArgs)
    ...
    Private Sub lstList2_SelectedIndexChanged_1(sender As System.Object, e As System.EventArgs) Handles lstList2.SelectedIndexChanged
        Dim viewlst As New ListViewItem
        For Each viewlst In lstList2.Items
            If viewlst.Selected = True Then
                EntID = viewlst.SubItems(0).Text
    ...
    Private Sub ToolStripButton3_Click_1(sender As System.Object, e As System.EventArgs) Handles cmdAbout.Click
        frmAbout.ShowDialog()
    End Sub

    Private Sub cmdAdd_Click_1(sender As System.Object, e As System.EventArgs) Handles cmdAdd.Click
        With frmAddCapturer
            .txtTitle.Text = "Add Capturer"
            .cboZone.Enabled = True
            .cboZone.Text = vbNullString
            .txtZoneHost.Text = vbNullString
            .ShowDialog()
    ...
    Private Sub cmdCEdit_Click_1(sender As System.Object, e As System.EventArgs) Handles cmdCEdit.Click
        If CapID = vbNullString Then Exit Sub

        With frmAddCapturer
            .txtTitle.Text = "Update Capturer"
            .cboZone.Enabled = False
            .cboZone.Text = CapID
            .txtZoneHost.Text = CapIPad
            .ShowDialog()
        End With
    End Sub

    Private Sub cmdCDel_Click_1(sender As System.Object, e As System.EventArgs) Handles cmdCDel.Click
        If CapID = vbNullString Then Exit Sub
        If conLocal() = False Then
            MsgBox("Please connect to database! ", vbExclamation, "Delete")
            Exit Sub
    ...
    Private Sub cmdCommandC_Click_1(sender As System.Object, e As System.EventArgs) Handles cmdCommandC.Click
         If CapID = vbNullString Then Exit Sub
        With frmCcomand
            .txtCapturer.Text = CapID
            .ShowDialog()
        End With
    End Sub
    ...
    Private Sub ListView1_SelectedIndexChanged_1(sender As System.Object, e As System.EventArgs) Handles ListView1.SelectedIndexChanged
        Dim viewlst As New ListViewItem
        For Each viewlst In ListView1.Items
            If viewlst.Selected = True Then
                CapID = viewlst.SubItems(0).Text
                CapIPad = viewlst.SubItems(1).Text
            End If
        Next
    End Sub

    Private Sub ToolStripButton3_Click_2(sender As System.Object, e As System.EventArgs) Handles ToolStripButton3.Click
        With frmAddPOS
            .lblTitle.Text = "New RPT"
            .cboStation.Enabled = True
            .txtIp1.Text = vbNullString
            .txtPwd.Text = vbNullString
            .txtUser.Text = vbNullString
    ...
    Private Sub frmPMSmain_Shown(sender As Object, e As System.EventArgs) Handles Me.Shown

    End Sub

    Private Sub ToolStripButton6_Click(sender As System.Object, e As System.EventArgs) Handles ToolStripButton6.Click
        frmAddPOS.lblTitle.Text = "Update RPT"
        frmAddPOS.cboStation.Enabled = False
        Dim viewlst As New ListViewItem
        For Each viewlst In lstRPT.Items
            If viewlst.Selected = True Then
                id = viewlst.SubItems(0).Text
                edit(id)
                frmAddPOS.ShowDialog()
    ...
    Private Sub lstRPT_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles lstRPT.SelectedIndexChanged
        ...
        For Each viewlst In lstRPT.Items
            If viewlst.Selected = True Then
                ...
                If PingMe(C_ip) = True Then
                    If conClient(C_ip, C_uid, C_pwd, C_port, C_db) = True Then
                        frmDownload.txtTRec.Text = viewVolume()
                        frmDownload.txtTrec2.Text = viewVolume() & " / 0"
                        frmDownload.ShowDialog()
                    Else
                        MsgBox("Failed to connect!    ", vbExclamation, "RPT Client")
                    End If
                Else
                    MsgBox("Failed to connect!    ", vbExclamation, "RPT Client")
                End If
    ...
    Private Sub cmdParkerHistory_Click(sender As System.Object, e As System.EventArgs) Handles cmdParkerHistory.Click
        frmParkerHistory.ShowDialog()
    End Sub
End Class