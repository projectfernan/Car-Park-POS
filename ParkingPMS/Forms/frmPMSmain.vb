...
Public Class frmPMSmain
            ...
            If viewlst.Selected = True Then
                ...
                If PingMe(C_ip) = True Then
                    If conClient(C_ip, C_uid, C_pwd, C_port, C_db) = True Then
                        ...
                        frmDownload.txtCnt.Text = "0 / " & viewVolume()
    ...
    Private Sub ToolStripButton4_Click(sender As System.Object, e As System.EventArgs) Handles cmdMonthly.Click
        frmMonthlyrate.ShowDialog()
    End Sub
    ...
    Private Sub cmdCEdit_Click(sender As System.Object, e As System.EventArgs) Handles cmdCEdit.Click
    ...
    Private Sub cmdCDel_Click(sender As System.Object, e As System.EventArgs) Handles cmdCDel.Click
        If CapID = vbNullString Then Exit Sub
        If conLocal() = False Then
            MsgBox("Please connect to database! ", vbExclamation, "Delete")
            Exit Sub
    ...
    Private Sub cmdCommandC_Click(sender As System.Object, e As System.EventArgs) Handles cmdCommandC.Click
        If CapID = vbNullString Then Exit Sub
        With frmCcommand
