...
Public Class frmConnDB
    ...
    Private Sub frmConnDB_FormClosing(sender As Object, e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        With frmPMSmain
    ...
    Private Sub frmConnDB_Shown(sender As Object, e As System.EventArgs) Handles Me.Shown
        With frmPMSmain
