...
Public Class frmAddPOS
    ...
    Sub saveSDB()
        If MsgBox("Are you sure your entries are correct?    ", vbYesNo + vbQuestion + vbDefaultButton2, "Save") = vbYes Then
            ...
            frmPMSmain.lstRPT.Clear()
            frmPMSmain.RPTHeader()
            frmPMSmain.fillRPT()
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        If lblTitle.Text = "New POS" Or lblTitle.Text = "New RPT" Then
    ...
    Private Sub frmAddPOS_Shown(sender As Object, e As System.EventArgs) Handles Me.Shown
        If lblTitle.Text = "New POS" Then
            Dim lup As Integer
            Dim lup2 As Integer = 100
            cboStation.Items.Clear()
            For lup = 1 To lup2
                cboStation.Items.Add("Station " & lup.ToString)
            Next

            cboStation.Focus()
        ElseIf lblTitle.Text = "New RPT" Then
            Dim lup As Integer
            Dim lup2 As Integer = 100
            cboStation.Items.Clear()
            For lup = 1 To lup2
                cboStation.Items.Add("RPT " & lup.ToString)
            Next
        Else
            txtArea.Focus()
        End If
