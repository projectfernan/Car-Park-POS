...
Public Class frmReportDT
    ...
    Sub Head()
        ...
        lstList.Columns.Add("Station", w, HorizontalAlignment.Left)
    ...
    Sub EntSrchL()
        ...
        rsDt = New Recordset
        rsDt = conSqlLoc.Execute("select * from tblIncomeReport where TimeOut >= '" & TmeInFrm & "' and TimeOut <='" & TmeInTo & "'")
    ...
    Sub SrchOpL()
        ...
        rsDt = New Recordset
        rsDt = conSqlLoc.Execute("select * from tblIncomeReport where Operator like '" & cboOp.Text & "%' and TimeOut >= '" & TmeInFrm & "' and TimeOut <='" & TmeInTo & "'")
        If rsDt.EOF = False Then
            For lup = 1 To rsDt.RecordCount
                lstList.Refresh()
                Dim viewlst As New ListViewItem
    ...
    Sub SrchStL()
        ...
        rsDt = New Recordset
        rsDt = conSqlLoc.Execute("select * from tblIncomeReport where Station like '" & cboStation.Text & "%' and TimeOut >= '" & TmeInFrm & "' and TimeOut <='" & TmeInTo & "'")
        If rsDt.EOF = False Then
            For lup = 1 To rsDt.RecordCount
                lstList.Refresh()
                Dim viewlst As New ListViewItem
    ...
    Sub SrchVhL()
        ...
        rsDt = New Recordset
        rsDt = conSqlLoc.Execute("select * from tblIncomeReport where VehicleType like '" & cboVehicle.Text & "%' and TimeOut >= '" & TmeInFrm & "' and TimeOut <='" & TmeInTo & "'")
        If rsDt.EOF = False Then
            For lup = 1 To rsDt.RecordCount
                lstList.Refresh()
                Dim viewlst As New ListViewItem
