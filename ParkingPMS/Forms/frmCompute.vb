    ...
    Private Sub cmdCompute_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdCompute.Click
        ...
        Select Case cboCtype.Text
            Case "Flat Rate"
                ...
                lblTotalAmount.Text = Compute_FlateRATE(cboVtype.Text, dtFrm.Value.ToString, dtTo.Value.ToString)
            Case "Hourly"
                lbltotalTime.Text = TotalTime_FUNCTION(dtFrm.Value.ToString, dtTo.Value.ToString)
                lblTotalAmount.Text = HourLy_RATE(cboVtype.Text, dtFrm.Value.ToString, dtTo.Value.ToString)
        End Select
    End Sub
