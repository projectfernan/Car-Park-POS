...
Public Class CRopSummaryRate
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ParkingPMS.CRopSummaryRate.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRopSummaryRate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRopSummaryRate = New CRopSummaryRate()
        rpt.Site = Me.Site
        Return rpt
    End Function
