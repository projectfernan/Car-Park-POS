...
Public Class CRSummaryReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ParkingPMS.CRSummaryReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRSummaryReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRSummaryReport = New CRSummaryReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
