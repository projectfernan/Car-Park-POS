...
Public Class crtAccSummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ParkingPMS.crtAccSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrtAccSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crtAccSummary = New crtAccSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
