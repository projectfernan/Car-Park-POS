...
Public Class PickLoadGraphdt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ParkingPMS.PickLoadGraphdt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPickLoadGraphdt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PickLoadGraphdt = New PickLoadGraphdt
        rpt.Site = Me.Site
        Return rpt
    End Function
