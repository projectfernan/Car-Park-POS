...
Public Class PickLoadGraphTme
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ParkingPMS.PickLoadGraphTme.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPickLoadGraphTme
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PickLoadGraphTme = New PickLoadGraphTme
        rpt.Site = Me.Site
        Return rpt
    End Function
