...
Public Class frmZreport
    ...
    Function GetMinOR(ByVal dt As Date, ByVal St As String, ByVal Field As String) As String
        ...
        Try
            ...
            SQL = "SELECT MIN(" & Field & ") AS T FROM tblincomereport WHERE Station='" & pc & "' and BussDate LIKE '" & a & "%'"
    ...
    Function GetMaxOR(ByVal dt As Date, ByVal St As String, ByVal Field As String) As String
        ...
        Try
            ...
            SQL = "SELECT MAX(" & Field & ") AS T FROM tblincomereport WHERE Station='" & pc & "' and BussDate LIKE '" & a & "%'"
    ...
    Private Function GET_TRcnt(ByVal d1 As Date) As String
        ...
        Try
            ...
            SQL = "SELECT * FROM tblincomereport WHERE Station='" & pc & "' and BussDate LIKE '" & a & "%'"
    ...
    Private Function GET_GTNEW(ByVal d1 As Date, ByVal T_field As String) As Double
        ...
        Try
            ...
            SQL = "SELECT SUM(" & T_field & ") AS T FROM tblincomereport WHERE Station='" & pc & "' and BussDate LIKE '" & a & "%'"
