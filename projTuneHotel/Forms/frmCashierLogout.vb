...
Public Class frmCashierLogout
    ...
    Private Sub frmCashierLogout_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        chkLogout.Checked = My.Settings.LogoutRep
    ...
    Private Sub chkLogout_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkLogout.CheckedChanged
        My.Settings.LogoutRep = chkLogout.Checked
    End Sub
End Class