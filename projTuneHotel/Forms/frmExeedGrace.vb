Public Class frmExeedGrace
    ...
    Sub viewAmt()
        Dim intAmt As Double = Get_IntervalAmt(cboVtype.Text, EntryTime, Now)
        ...
        With frmMain
            ...
            .lblTimeIn.Text = Format(CDate(tmeIn), "yyyy-MM-dd HH:mm:00")
            .lblTimeOut.Text = Format(Now, "yyyy-MM-dd HH:mm:59")
            .lblTotalTime.Text = TotalTime_FUNCTION(CDate(tmeIn), Now)
