...
Module Log_Out_Print
    ...
    Private Sub LOPrint_Print(ByVal sender As System.Object, ByVal e As PrintPageEventArgs) Handles LOPrint.PrintPage
        Try
            ...
            rs1 = conSqlPOS.Execute("select Count(VehicleType)as VehicleCount from tblincomereport where PayType = 'GracePeriod' and Station = '" & strStation & "' and Operator = '" & strOp & "' and BussDate like '" & strBussDate & "%'")
            ...
            rs = conSqlPOS.Execute("select VehicleType,Count(VehicleType)as VehicleCount,sum(total)as VehicleTotalAmt from tblincomereport where Station = '" & strStation & "' and Operator = '" & strOp & "' and BussDate like '" & strBussDate & "%' group by VehicleType")
            Do While rs.EOF = False
                y += (lineOffset * 2.0)
                e.Graphics.DrawString(rs("VehicleType").Value, printFont, Brushes.Black, x, y - 5)
                e.Graphics.DrawString(rs("VehicleCount").Value, printFont, Brushes.Black, x + 111, y - 5)
                rs.MoveNext()
            Loop
            ...
            rs2 = conSqlPOS.Execute("select Count(LostCard)as LostCount from tblincomereport where LostCard > 0 and Station = '" & strStation & "' and Operator = '" & strOp & "' and BussDate like '" & strBussDate & "%'")
    ...
    Public Function TotalTR(ByVal op As String, ByVal Station As String, ByVal petsa1 As Date) As Integer
        ...
        Try
            ...
            Dim rs As New Recordset
            rs = New Recordset
            rs = conSqlPOS.Execute("select * from tblincomereport where Station = '" & Station & "' and Operator = '" & op & "' and BussDate like '" & dt1 & "%'")
            If rs.EOF = False Then
    ...
    Public Function TotalNet(ByVal op As String, ByVal Station As String, ByVal petsa1 As Date) As Double
        ...
        Try
            ...
            Dim rs As New Recordset
            rs = New Recordset
            rs = conSqlPOS.Execute("select sum(Total) as TotalNet from tblincomereport where Station = '" & Station & "' and Operator = '" & op & "' and BussDate like '" & dt1 & "%'")
            If rs.EOF = False Then
    ...
    Public Function TotalVat(ByVal op As String, ByVal Station As String, ByVal petsa1 As Date) As Double
        ...
        Try
            ...
            Dim rs As New Recordset
            rs = New Recordset
            rs = conSqlPOS.Execute("select sum(Vat) as TotalVat from tblincomereport where Station = '" & Station & "' and Operator = '" & op & "' and BussDate like '" & dt1 & "%'")
            If rs.EOF = False Then
    ...
    Public Function TotalVatSale(ByVal op As String, ByVal Station As String, ByVal petsa1 As Date) As Double
        ...
        Try
            ...
            Dim rs As New Recordset
            rs = New Recordset
            rs = conSqlPOS.Execute("select sum(SubTotal) as TotalVatSale from tblincomereport where Station = '" & Station & "' and Operator = '" & op & "' and BussDate like '" & dt1 & "%'")
            If rs.EOF = False Then
