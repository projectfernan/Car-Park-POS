Module CamSettings
    ...
    Public Sub camEntrance()
        ...
        Try
            With frmMain
                ...
                .CamEntry.StartRealPlay(frmCamSettings.CaptureEnt.Value, 0, 0)
                If val < 0 Then
    ...
    Public Sub camEntrance1()
        'CAM_CLOSE()
        Dim val As Long
        Try
            With frmMain
                val = .CamEnt.Login(frmCamSettings.txtIp.Text, frmCamSettings.txtPort.Text, frmCamSettings.txtUser.Text, frmCamSettings.txtPass.Text)
                .CamEnt.StartRealPlay(frmCamSettings.ChanEntry.Value, 0, 0)
                If val < 0 Then
