...
Public Class frmZreport
    ...
    Sub savelast(ByVal dt As Date, ByVal Actotal As Double)
        ...
        Try
            ...
            If rsChk.EOF = False Then
                Dim rs As New Recordset
                rs = New Recordset
                rs = conSqlLoc.Execute("update tbllastzread set AccumSales = " & Actotal & " where LastRead ='" & DTnow & "'")
            Else
                Dim rs As New Recordset
                rs = New Recordset
                rs = conSqlLoc.Execute("insert into tbllastzread(LastRead,AccumSales)VALUES('" & DTnow & "'," & Actotal & ")")
            End If
