...
Module PrintReceipt
    ...
    Private Sub pdPrint_Print(ByVal sender As System.Object, ByVal e As PrintPageEventArgs) Handles pdPrint.PrintPage
        ...
        y += (lineOffset * 2.75)
        e.Graphics.DrawString("Owned and Operated by : ", printFont, Brushes.Black, x, y - 9)
        y += (lineOffset * 2.0)
        e.Graphics.DrawString(" " & My.Settings.OperatedBy, printFont, Brushes.Black, x - 2, y - 9)
        y += (lineOffset * 2.27)
        e.Graphics.DrawString(My.Settings.ADDR, printFont, Brushes.Black, x, y - 7)
        y += (lineOffset * 2.0)
        ...
        y += (lineOffset * 2.0)
        e.Graphics.DrawString("24Hours :", printFont, Brushes.Black, x, y - 5)
        ...
        y += (lineOffset * 2.0)
        e.Graphics.DrawString("VAT Exempt :", printFont, Brushes.Black, x, y - 5)
        e.Graphics.DrawString("P" + " " + MakeMoney(P_VatExemp), printFont, Brushes.Black, x + 85, y - 5)
        ...
        y += (lineOffset * 2.0)
        e.Graphics.DrawString("Permit #: " & P_Permit, printFont, Brushes.Black, x + 20, y)

        y += (lineOffset * 2.0)
        e.Graphics.DrawString("Permit Date Effective : " & Format(My.Settings.N_PermitDateIssued, "yyyy-MM-dd"), printFont, Brushes.Black, x + 27, y)
