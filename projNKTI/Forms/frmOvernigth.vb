    ...
    Private Sub cmdAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAdd.Click
        ...
        If conLocal() = True Then
            ...
            Else
                ...
                fillL()
                cmdAdd.Text = "&Add"
                saveAudiUpdate(str_SysUser, str_SysPosi, "New overnight rule created")
            End If
    ...
    Private Sub cmdEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdEdit.Click
        ...
        If conLocal() = True Then
            ...
            Else
                ...
                fillL()
                cmdEdit.Text = "&Edit"
                saveAudiUpdate(str_SysUser, str_SysPosi, "Overnight rule updated")
            End If
    ...
    Private Sub cmdDel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDel.Click
        If MsgBox("Are you sure do you want to delete this record?    ", vbYesNo + vbQuestion + vbDefaultButton2, "Delete") = vbYes Then
            If frmMain.dbstat2.Text = "Connected" Then
                ...
                header()
                fillL()
                saveAudiUpdate(str_SysUser, str_SysPosi, "Overnight rule deleted")
            Else
                MsgBox("Please connect to database!    ", vbExclamation, "Database Connection")
                frmConnDB.ShowDialog()
            End If
