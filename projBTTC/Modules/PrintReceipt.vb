...
Module PrintReceipt
    ...
    Private Sub pdPrint_Print(ByVal sender As System.Object, ByVal e As PrintPageEventArgs) Handles pdPrint.PrintPage
        ...
        Dim printFontOR As New Font("Microsoft Sans Serif", 8, FontStyle.Bold, GraphicsUnit.Point)
        ...
        y += (lineOffset * 2.0)
        e.Graphics.DrawString(" Contact No.: " & My.Settings.CONTACT, printFont, Brushes.Black, x - 2, y - 8)
        ...
        y += (lineOffset * 3.0)
        e.Graphics.DrawString("Hourly :", printFont, Brushes.Black, x, y - 5)
        ...
        y += (lineOffset * 2.0)
        e.Graphics.DrawString(My.Settings.N_PosVendor, printFont, Brushes.Black, x - 2, y - 5)
        '  e.Graphics.DrawString(My.Settings.N_PosVendor, printFont, Brushes.Black, x + 57, y - 5)
        y += (lineOffset * 2.0)
        e.Graphics.DrawString(My.Settings.N_PosVendorAddr, printFont, Brushes.Black, x - 2, y - 5)
        'e.Graphics.DrawString(My.Settings.N_PosVendorAddr, printFont, Brushes.Black, x + 57, y - 5)
        y += (lineOffset * 2.0)
        e.Graphics.DrawString("VAT Reg. TIN :", printFont, Brushes.Black, x - 2, y - 5)
        e.Graphics.DrawString(My.Settings.N_PosVendorTin, printFont, Brushes.Black, x + 64, y - 5)
        y += (lineOffset * 2.0)
        e.Graphics.DrawString("Accr #: ", printFont, Brushes.Black, x - 2, y)
        e.Graphics.DrawString(P_ACCR, printFont, Brushes.Black, x + 84, y)
        y += (lineOffset * 2.0)
        e.Graphics.DrawString("Accr Date : ", printFont, Brushes.Black, x - 2, y)
        e.Graphics.DrawString(Format(My.Settings.N_AccrDate, "yyyy-MM-dd"), printFont, Brushes.Black, x + 84, y)
        y += (lineOffset * 2.0)
        e.Graphics.DrawString("Permit #: ", printFont, Brushes.Black, x - 2, y)
        e.Graphics.DrawString(P_Permit, printFont, Brushes.Black, x + 84, y)
        y += (lineOffset * 2.0)
        e.Graphics.DrawString("Permit Date Issued : ", printFont, Brushes.Black, x - 2, y)
        e.Graphics.DrawString(Format(My.Settings.N_PermitDateIssued, "yyyy-MM-dd"), printFont, Brushes.Black, x + 84, y)
